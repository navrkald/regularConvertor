...
Pro vývoj tohoto programu byl zvolen jazyk C++ ve verzi standardu 11 spolu s multiplatformním frameworkem Qt v nejnovější verzi 5, protože moje požadavky byly, aby aplikace používala nové moderní technologie a také, aby byla přenositelná na všechny hlavní operační systémy.
...
\n{1}{Stažení zdrojových souborů a jejich následná kompilace}
...
\n{2}{Přepsání třídy hlavního okna}
...
\n{2}{Popis nejduležitějších tříd zajišťující převod bezkontextové gramatiky na zásobníkový automat}
...
Another link to Qt ModelEditor \url{http://doc.qt.io/qtcreator/creator-modeling.html}
...
TODO: Implementace hlavního okna, zmínit se třídě MyTooltipQMenu, která implementuje ukazování obrázků jako tooltipů nad položkami v menu a tím že menu Context-Free grammar je povýšena na MyTooltipQMenu a uvest diagram třídy. Zmínit se, že kazdy example má u sebe screenshot
